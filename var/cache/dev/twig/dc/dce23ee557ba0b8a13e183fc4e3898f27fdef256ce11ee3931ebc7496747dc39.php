...
";
        ...
        <tbody>
            ...
            <td>";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "descripstion", [], "any", false, false, false, 19), "html", null, true);
            echo "</td>
            <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "price", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
        
        </tbody>
                <td><a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("delete", ["id" => twig_get_attribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\">Supprimer</a></td>
...
";
    ...
    {
        return array (  127 => 23,  121 => 20,  117 => 19,  113 => 18,  109 => 17,  99 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<p><a href=\"{{ path('create') }}\">Ajouter un produit</a></p>
{% for post in posts %}
    <table>
        <thead>
            <th>ID</th>
        ...
        <tbody>
            ...
            <td>{{ post.price }}</td>
                ...
                <td><a href=\"{{ path('delete', {'id': post.id}) }}\">Supprimer</a></td>

    </table>
{% endfor %}
{% endblock %}
", "post/show.html.twig", "/Applications/Ampps/www/tarafoto/templates/post/show.html.twig");
    }
}
